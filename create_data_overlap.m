...
for i=1:n_mod_types
    ...
    while e<(i*n_samples_per_mod)
        ...
        frames=cut_signal_overlap(signal,size_sample);
...
name_save=['dataset_overlap_' num2str(size_sample) '_' num2str(n_samples_per_mod) '_snr_' num2str(min_snr) '_' num2str(max_snr)];
